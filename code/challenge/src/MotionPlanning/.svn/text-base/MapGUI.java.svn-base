...
public class MapGUI extends SonarGUI implements NodeMain{
  ...
  private Subscriber<org.ros.message.lab6_msgs.GUIPolyMsg> guiPathSub;
    ...
    public void onStart(Node node) {
      ...
      guiPathSub = node.newSubscriber("gui/Path", "lab6_msgs/GUIPolyMsg");
      guiPathSub.addMessageListener(new PolyMessageListener(this));
      super.onStart(node);
    }
